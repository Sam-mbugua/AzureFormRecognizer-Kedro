...
# kedro_setup_formrecognizer documentation build
...
from kedro_setup_formrecognizer import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_setup_formrecognizer"
author = "Kedro"
...
htmlhelp_basename = "kedro_setup_formrecognizerdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_setup_formrecognizer.tex",
        "kedro_setup_formrecognizer Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_setup_formrecognizer",
        "Project kedro_setup_formrecognizer codebase.",
        "Data-Science",
    )
]
